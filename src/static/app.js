    ...
    try {
      ...
      Object.entries(activities).forEach(([name, details]) => {
        ...
        const participantsHtml = details.participants && details.participants.length
          ? '<ul class="participants-list">' + details.participants.map(function(p) {
              return '<li><span class="participant-email">' + p + '</span><button class="remove-participant" data-activity="' + name + '" data-email="' + p + '" title="Remove participant">✖</button></li>'; 
            }).join('') + '</ul>'
